    ...
    <div className="fixed top-0 left-0 w-full   bg-gray-50  p-4 flex justify-between items-center z-50 font-mono">
      ...
      <form class="max-w-md mx-auto">   
            ...
            <div class="relative">
                ...
                <Link to='/blogs'><button type="submit" class="text-gray absolute mr-2.5 end-2.5 bottom-2.5 bg-blue-200 hover:bg-blue-100 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 hover:bg-blue-100 dark:focus:ring-blue-800">Search</button></Link>
            </div>
      </form>
